...
import { primeHandoffAlarmUnlock } from "@/lib/handoff-alarm-audio";
    ...
    <div className="grid min-h-screen place-items-center bg-gradient-to-br from-primary/10 via-background to-accent/10 px-4">
      <Card className="w-full max-w-sm p-6">
        <div className="mb-4 flex items-center gap-2">
          <div className="grid size-10 place-items-center rounded-xl bg-primary text-primary-foreground"><Store className="size-5" /></div>
          <div>
            <h1 className="font-bold">Área da loja</h1>
        ...
        <p className="mt-4 text-center text-xs text-muted-foreground">
          É entregador? <a href="/entregador/login" className="underline">Acesse por aqui</a>
        </p>
        <p className="mt-1 text-center text-xs text-muted-foreground">
          Voltar ao <a href="/" className="underline">cardápio</a>
        </p>
      </Card>
    </div>
  );
